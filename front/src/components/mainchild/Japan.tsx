...
const Japan: React.FC = () => {
  ...
  return (
    <div>
      ...
      <div onClick={()=>stageStart(2)} className={styles.unactive_stage2}>{stageTwoAns}/10</div>
      <div onClick={()=>stageStart(3)} className={styles.unactive_stage3}>{stageThreeAns}/10</div>
      <div onClick={()=>stageStart(4)} className={styles.unactive_stage4}>{stageFourAns}/10</div>
      <div onClick={()=>stageStart(5)} className={styles.unactive_stage5}>{stageFiveAns}/10</div>
