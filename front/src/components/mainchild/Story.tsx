...
const Story:React.FC= () => {
    ...
    return (
      ...
      <div className={styles.storyNavigation}>
        <button className={styles.button} onClick={goToPreviousStory} disabled={currentStoryIndex === 0}>
          Previous
        </button>
        <div className={styles.textfield}>
          <p>{stories[currentStoryIndex].text}</p>
        </div>
        <button className={styles.button} onClick={goToNextStory} disabled={currentStoryIndex === stories.length - 1}>
          Next
        </button>
      </div>
    </div>
