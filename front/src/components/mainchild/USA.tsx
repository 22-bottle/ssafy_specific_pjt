...
const USA:React.FC= () => {
    ...
    return (
        <div>
            ...
            <div onClick={() => stageStart(1)} className={styles.stage1}></div>
            {/* stage가 개방되었는지 확인하고 css 다르게 적용 기능 추가해야함 */}
            <div onClick={ () => stageStart(2) } className={styles.unactive_stage2}></div>
            <div onClick={ () => stageStart(3) } className={styles.unactive_stage3}></div>
            <div onClick={ () => stageStart(4) } className={styles.unactive_stage4}></div>
            <div onClick={ () => stageStart(5) } className={styles.unactive_stage5}></div>
